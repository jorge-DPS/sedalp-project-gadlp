    ...
    <div class="kt-container-fixed flex items-center justify-between flex-wrap gap-3">
      ...
      <div class="flex items-center flex-wrap gap-1.5 lg:gap-2.5">
        ...
        <div class="kt-menu kt-menu-default" data-kt-menu="true">
          ...
          >
            <button type="button" class="kt-menu-toggle kt-btn kt-btn-outline flex-nowrap">
            ...
            <div class="kt-menu-dropdown w-48 py-2 kt-scrollable-y max-h-[250px]">
              ...
              >
                <button type="button" class="kt-menu-link w-full" @click="selectedMonth = month">
    ...
    <div class="grid gap-5 lg:gap-7.5">
      <div id="integrations_cards">
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
          <div v-for="integration in integrations" :key="integration.name" class="kt-card">
            <div class="kt-card-content p-5 lg:p-7.5">
              <div class="flex items-center justify-between mb-3 lg:mb-5">
                <div class="flex items-center justify-center">
                  <img :alt="integration.name" class="h-11 shrink-0" :src="integration.logo" />
                </div>
            ...
            <div class="kt-card-footer justify-between items-center py-3.5">
              ...
              <div class="flex items-center gap-2.5">
                <input v-model="integration.connected" class="kt-switch" type="checkbox" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="kt-card-content flex flex-col items-center gap-2.5 py-7.5">
          ...
          <div class="flex flex-col gap-5 lg:gap-7.5">
            <div class="flex flex-col gap-3 text-center">
              <h2 class="text-xl font-semibold text-mono">Add New Integration</h2>
              <p class="text-sm text-foreground">
                Explore new integrations and expand your toolkit with efficient, user-friendly
                solutions.
              </p>
            </div>

            <div class="flex justify-center mb-5">
              <button type="button" class="kt-btn kt-btn-primary">Start Now</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="kt-card-content py-3">
          <div data-kt-accordion="true" data-kt-accordion-expand-all="true">
            ...
            >
              ...
              <div :id="`faq_${index + 1}_content`" class="kt-accordion-content hidden">
      ...
      <div class="grid lg:grid-cols-2 gap-5 lg:gap-7.5">
        <div class="kt-card">
          ...
          <div class="kt-card-footer justify-center">
            <button type="button" class="kt-link kt-link-underlined kt-link-dashed">
              Go to Help Center
            </button>
          </div>
        </div>
          ...
          <div class="kt-card-content px-10 py-7.5 lg:pr-12.5">
            <div class="flex flex-wrap md:flex-nowrap items-center gap-6 md:gap-10">
              <div class="flex flex-col items-start gap-3">
                ...
                <p class="text-sm text-foreground leading-5.5 mb-2.5">
                  Need assistance? Contact our support team for prompt, personalized help with your
